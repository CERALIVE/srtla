...
- `--stage screen|deep` → the full screen matrix / deep sweep (the cross-cell Holm-Bonferroni stats layer is the **T-A6** seam; this driver currently runs the candidate cells)
